...
/* harmony import */ var _ItemModal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ItemModal */ "./src/components/ItemModal.js");
/* harmony import */ var _AdminItem__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./AdminItem */ "./src/components/AdminItem.js");
...
function Item({
  ...
  const uniqRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  ...
  const details = {
    ...
    Bay: (0,_utilities_utilities__WEBPACK_IMPORTED_MODULE_2__.safeGet)(item, "bay"),
    Shelf: (0,_utilities_utilities__WEBPACK_IMPORTED_MODULE_2__.safeGet)(item, "shelf")
  };
  ...
  const itemWidth = Math.round(baseItemWidth * itemScale);
  const itemHeight = Math.round(baseItemHeight * itemScale);
  const [skuRef, skuText] = (0,_AdminItem__WEBPACK_IMPORTED_MODULE_4__.useFitText)(details.SKU || "", itemWidth);
  const itemStyle = {
    cursor: "pointer",
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "item-sku",
    ref: skuRef
  }, skuText), type === "panel" && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    className: "smallp"
    ...
    key: key
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", null, key, ":"), " ", value))), !backgroundImage &&
...
Item.propTypes = {
  item: prop_types__WEBPACK_IMPORTED_MODULE_5___default().shape({
    ...
    TharsternCode: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string).isRequired,
    ProductID: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string).isRequired,
    Category: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string),
    Code: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string),
    StockQty: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
    Horizontal: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string).isRequired,
    Vertical: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string).isRequired,
    URL1: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string).isRequired
  }).isRequired,
  context: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOf(["admin", "store"]).isRequired,
  ...
  disableAddToCart: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().bool),
  scale: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number)
};
...
/* harmony import */ var _utilities_addSingleProductToCart__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utilities/addSingleProductToCart */ "./src/utilities/addSingleProductToCart.js");
...
react_modal__WEBPACK_IMPORTED_MODULE_2___default().setAppElement("#content");
function ItemModal({
  isOpen,
  onClose,
  modalId,
  ...
  }, "Close"), disableAddToCart ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "disabled-message"
  }, "Single item cannot be added to cart") : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_AddButton__WEBPACK_IMPORTED_MODULE_1__["default"], {
  ...
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, Object.keys(details).map(key => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    key: key
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", null, key, ":"), " ", details[key]))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "modal-buttons common-container"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    onClick: e => {
      onClose();
...
ItemModal.propTypes = {
  ...
  modalId: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().string).isRequired,
  largeImgSrc: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().string).isRequired,
  details: prop_types__WEBPACK_IMPORTED_MODULE_4___default().shape({
  ...
  disableAddToCart: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().bool)
};
...
async function addToCart(productInfoArray) {
  ...
  try {
    ...
    const response = await Promise.race([fetch(API_ENDPOINT, {
      method: "POST",
      headers: {
...
const StoreApp = () => {
  ...
  const handleMakePermanentClick = async () => {
    ...
    try {
      ...
      if (result.success) {
        setShowButton(false);
        setMessage("Request successful, New fixture/Region assigned to this store.");
        setIsError(false);
      } else {
        setShowButton(true);
        setMessage("Something went wrong and cannot make permanent, please try again.");
        setIsError(true);
      }
    } catch (error) {
      // Error
          ...
          if (position.fixture_type === selectedFixtureType && (!selectedRegion || position.region === selectedRegion)) {
            ...
            if (position.shelf === "P") {
              ...
              if (position.horizontal === "LS" || position.horizontal === "RS" || position.horizontal === "CS") {
                baysResult[bayNumber].sidePanels.push({
                  ...position,
                  ...sku
                });
              } else if (position.horizontal === "M") {
                baysResult[bayNumber].backPanels.push({
                  ...position,
                  ...sku
                });
              } else {
              ...
              baysResult[bayNumber].shelves[position.shelf].push({
                ...position,
                ...sku
              });
            }
  ...
  const renderSingleBay = (bayNumber, bayData, isMultiBay) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: bayNumber,
    className: "bay-container",
    id: `bay-${bayNumber}`
  }, isMultiBay && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, "Bay ", bayNumber), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, "Side Panels"), bayData.sidePanels.length > 0 && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_StoreShelf__WEBPACK_IMPORTED_MODULE_6__["default"], {
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, "Back Panels"), bayData.backPanels.length > 0 && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_StoreShelf__WEBPACK_IMPORTED_MODULE_6__["default"], {
  ...
  const renderTwoUpShelfCell = (bayNumber, shelfLabel, items) => {
    ...
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_StoreShelf__WEBPACK_IMPORTED_MODULE_6__["default"], {
      positions: items,
      shelfLabel: shelfLabel,
      data: data,
      bayNumber: bayNumber
  ...
  const renderTwoUp = sortedBayEntries => {
    ...
    const allShelfLabels = Array.from(new Set([...Object.keys(bay1Data.shelves), ...Object.keys(bay2Data.shelves)])).sort((a, b) => {
      const an = parseFloat(a);
      const bn = parseFloat(b);
      if (Number.isFinite(an) && Number.isFinite(bn)) return an - bn;
      return String(a).localeCompare(String(b));
    });
    const showSidePanels = bay1Data.sidePanels.length > 0 || bay2Data.sidePanels.length > 0;
    const showBackPanels = bay1Data.backPanels.length > 0 || bay2Data.backPanels.length > 0;
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "store-fixture store-fixture--two-up"
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      id: `bay-${bay1Number}`
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, "Bay ", bay1Number, " Face")), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "bay-col-header",
      id: `bay-${bay2Number}`
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, "Bay ", bay2Number, " Face"))), allShelfLabels.map(shelfLabel => {
      ...
      }, renderTwoUpShelfCell(bay1Number, shelfLabel, bay1Regular), renderTwoUpShelfCell(bay2Number, shelfLabel, bay2Regular)), wideItems.length > 0 && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "shelf-row__wide"
      }, wideItems.map(item => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_Item__WEBPACK_IMPORTED_MODULE_5__["default"], {
        item: item,
      ...
      onClickHandler: handleAddAllFixtureClick,
      text: "Add All Face items to cart"
    }))), showSidePanels && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "bays-side-panels-display",
      ref: sidePanelsDisplayRef
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, "Side Panels"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "bays-panels-row"
    }, sortedBayEntries.map(([bayNumber, bayData]) => bayData.sidePanels.length > 0 ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      key: bayNumber,
      className: "bay-panels-cell"
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h4", null, "Bay ", bayNumber), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_StoreShelf__WEBPACK_IMPORTED_MODULE_6__["default"], {
      key: `${selectedFixtureType}-${selectedRegion}-${bayNumber}-side`,
      positions: bayData.sidePanels,
      shelfLabel: "P",
      data: data,
      ...
      onClickHandler: handleAddAllSidePanelFixtureClick,
      text: "Add All Side Panel items to cart"
    }))), showBackPanels && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "bays-back-panels-display",
      ref: backPanelsDisplayRef
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, "Back Panels"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "bays-panels-row"
    }, sortedBayEntries.map(([bayNumber, bayData]) => bayData.backPanels.length > 0 ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      key: bayNumber,
      className: "bay-panels-cell"
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h4", null, "Bay ", bayNumber), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_StoreShelf__WEBPACK_IMPORTED_MODULE_6__["default"], {
      key: `${selectedFixtureType}-${selectedRegion}-${bayNumber}-back`,
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h4", null, "Do you want to make the new selection permanent?"), showButton && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    style: {
      margin: "0.5em"
    },
  ...
  }, "Make Permanent"), message && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    style: {
      color: isError ? "red" : "green"
    }
  }, message)))), processAndDisplayData()));
};
...
function StoreShelf({
  ...
  const isTopShelfPosition = item => String(item.horizontal) === "8" && String(item.vertical) === "2";

  // Group by horizontal value (with the synthetic 8/2 split when applicable)
  let groupedByHorizontal = positions.reduce((acc, item) => {
    const horizontal = shelfLabel !== "P" && isTopShelfPosition(item) ? topShelfGroupKey : item.horizontal;
    if (!acc[horizontal]) {
      acc[horizontal] = [];
    }
...
/***/ "./src/utilities/addSingleProductToCart.js":
/*!*************************************************!*\
  !*** ./src/utilities/addSingleProductToCart.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addSingleProductToCart: () => (/* binding */ addSingleProductToCart)
/* harmony export */ });
...
/***/ "./src/utilities/gatherAndCallAPI.js":
/*!*******************************************!*\
  !*** ./src/utilities/gatherAndCallAPI.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   gatherProductInfoAndCallAPI: () => (/* binding */ gatherProductInfoAndCallAPI)
/* harmony export */ });
/* harmony import */ var _services_addToCart__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/addToCart */ "./src/services/addToCart.js");
...
async function gatherProductInfoAndCallAPI(parentElement) {
  ...
  const productElements = parentElement.querySelectorAll("[data-product-id][data-product-code]");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   extractShelfNumber: () => (/* binding */ extractShelfNumber),
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _StoreApp__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./StoreApp */ "./src/stores/StoreApp.js");



const appRoot = document.querySelector(".wp-block-vml-fixtures-store");
if (appRoot) {
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.render)((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_StoreApp__WEBPACK_IMPORTED_MODULE_2__["default"], null), appRoot);
}
})();
