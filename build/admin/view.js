...
FaceDataDisplay.propTypes = {
  faceData: prop_types__WEBPACK_IMPORTED_MODULE_2___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_2___default().object)).isRequired
};
...
function Item({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "smallp"
  }, details.Description), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_tooltip__WEBPACK_IMPORTED_MODULE_1__.Tooltip, {
    ...
    key: key
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", null, key, ":"), " ", details[key]) : null)));
}
Item.propTypes = {
...
/* harmony import */ var _components_ItemGroup__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/ItemGroup */ "./src/components/ItemGroup.js");
...
function Shelf({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `shelf shelf-${(0,_utilities_utilities__WEBPACK_IMPORTED_MODULE_1__.extractShelfNumber)(shelfKey)}`
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, shelfKey), horizontalData.map((data, horizontalIndex) => {
    const horizontalKey = Object.keys(data)[0];
    const items = data[horizontalKey];
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_ItemGroup__WEBPACK_IMPORTED_MODULE_2__["default"], {
      items: items,
...
Shelf.propTypes = {
  shelfData: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object).isRequired
};
...
/* harmony import */ var react_spinners_PropagateLoader__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react-spinners/PropagateLoader */ "./node_modules/react-spinners/PropagateLoader.js");
/* harmony import */ var react_spinners_PropagateLoader__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(react_spinners_PropagateLoader__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _components_FaceDataDisplay__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/FaceDataDisplay */ "./src/components/FaceDataDisplay.js");
...
function FrontendApp() {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    (0,_services_dataService__WEBPACK_IMPORTED_MODULE_3__["default"])().then(fetchedData => {
      setData(fetchedData);
      setLoading(false);
    }).catch(err => {
  ...
  if (loading) {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "loading"
    }, "Loading fixture...", (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)((react_spinners_PropagateLoader__WEBPACK_IMPORTED_MODULE_4___default()), {
      color: "#008fca",
