...
/* harmony import */ var _services_getOptionService__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/getOptionService */ "./src/services/getOptionService.js");
/* harmony import */ var _components_ShelfRenderer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/ShelfRenderer */ "./src/components/ShelfRenderer.js");
/* harmony import */ var _components_AdminItem__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/AdminItem */ "./src/components/AdminItem.js");
/* harmony import */ var _utilities_shelfUtils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utilities/shelfUtils */ "./src/utilities/shelfUtils.js");
/* harmony import */ var _utilities_fixtureUtils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utilities/fixtureUtils */ "./src/utilities/fixtureUtils.js");
...
const RootApp = () => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
    async function fetchData() {
      try {
        const response = await (0,_services_getOptionService__WEBPACK_IMPORTED_MODULE_5__.fetchOptionData)();
        if (!response?.data) {
          ...
          const fixtureTypes = (0,_utilities_shelfUtils__WEBPACK_IMPORTED_MODULE_8__.getUniqueValues)(jsonData, "fixture_type");
          const regions = (0,_utilities_shelfUtils__WEBPACK_IMPORTED_MODULE_8__.getUniqueValues)(jsonData, "region");
  ...
  const uniqueFixtureTypes = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => (0,_utilities_shelfUtils__WEBPACK_IMPORTED_MODULE_8__.getUniqueValues)(data, "fixture_type"), [data]);
  const uniqueRegions = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => selectedFixtureType ? (0,_utilities_fixtureUtils__WEBPACK_IMPORTED_MODULE_9__.getRegionsForSelectedFixture)(data, selectedFixtureType) : [], [data, selectedFixtureType]);

  // Memoize bays calculation to ensure it recalculates when fixture type or region changes
  const bays = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => {
    if (!data || typeof data.final_skus !== "object" || !selectedFixtureType) {
      return {};
    }
    return (0,_utilities_shelfUtils__WEBPACK_IMPORTED_MODULE_8__.organizeBayData)(data, selectedFixtureType, selectedRegion);
  ...
  const processAndDisplayData = () => {
    ...
    const hasSidePanels = (shelfP = []) => shelfP.some(i => ["LS", "CS", "RS"].includes(i.horizontal));
    const hasBackPanels = (shelfP = []) => shelfP.some(i => i.horizontal === "M");
    const renderBay = ([bayNumber, bayData]) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      key: bayNumber,
      ...
      href: `#bay-${bayNum}`,
      className: "bay-link"
    }, "Go to Bay ", bayNum)))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      showTooltip: true,
      scale: scale
    }))), hasSidePanels(bayData.shelfP) && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "side-panels-display"
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, "Side Panels"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_ShelfRenderer__WEBPACK_IMPORTED_MODULE_6__["default"], {
      ...
      panelType: "side",
      scale: scale
    })), hasBackPanels(bayData.shelfP) && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "back-panels-display"
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, "Back Panels"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_ShelfRenderer__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    const renderTwoUp = () => {
      ...
      const getSortedVerticals = items => [...new Set(items.map(item => String(item.vertical)))].sort((a, b) => {
        const an = parseFloat(a);
        const bn = parseFloat(b);
        if (Number.isFinite(an) && Number.isFinite(bn)) return bn - an;
        return String(b).localeCompare(String(a));
      });
      const getItemsForVertical = (items, vertical) => items.filter(item => String(item.vertical) === String(vertical));
      const shouldRenderFullWidthVertical = items => items.some(isHorizontalEight) || getItemsWidth(items) > FULL_WIDTH_ROW_THRESHOLD;
      ...
      const renderShelfCell = (bayNumber, positions, shelfLabel, hideTitle = false) => {
        ...
        }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_ShelfRenderer__WEBPACK_IMPORTED_MODULE_6__["default"], {
          positions: positions,
          shelfLabel: shelfLabel,
          bayNumber: bayNumber,
          data: data,
      ...
      const renderFullWidthVerticalRow = (items, shelfLabel, vertical) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        key: `${shelfLabel}-${vertical}-full`,
        className: "shelf-row__wide shelf-row__wide--vertical"
      }, sortItemsByBayAndHorizontal(items).map((item, idx) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_AdminItem__WEBPACK_IMPORTED_MODULE_7__["default"], {
      ...
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        if (unparseable.length > 0) {
          console.warn(`Shelf ${shelfLabel}: items with non-numeric width`, unparseable.map(i => ({
            code: i.code,
            width: i.width
          })));
        }
        return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
          ...
          className: "shelf-row__cells shelf-row__labels"
        }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
          className: "shelf-cell shelf-cell--label"
        }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
          className: "shelf-title common-container"
        }, "BAY ", bay1Number, "/SHELF ", shelfLabel)), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
          className: "shelf-cell shelf-cell--label"
        }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
          className: "shelf-title common-container"
        }, "BAY ", bay2Number, "/SHELF ", shelfLabel))), allVerticals.map(vertical => {
          ...
          }, renderShelfCell(bay1Number, bay1VerticalItems, shelfLabel, true), renderShelfCell(bay2Number, bay2VerticalItems, shelfLabel, true));
        }));
      })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        }, showSide && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
          className: "side-panels-display"
        }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, "Bay ", bayNumber, " Side Panels"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_ShelfRenderer__WEBPACK_IMPORTED_MODULE_6__["default"], {
          key: `${selectedFixtureType}-${selectedRegion}-${bayNumber}-side`,
          positions: bayData.shelfP,
          shelfLabel: "P",
          bayNumber: bayNumber,
          ...
          panelType: "side",
          scale: scale
        })), showBack && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
          className: "back-panels-display"
        }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, "Bay ", bayNumber, " Back Panels"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_ShelfRenderer__WEBPACK_IMPORTED_MODULE_6__["default"], {
          key: `${selectedFixtureType}-${selectedRegion}-${bayNumber}-back`,
          positions: bayData.shelfP,
          shelfLabel: "P",
          bayNumber: bayNumber,
...
/***/ "./src/components/ShelfRenderer.js":
/*!*****************************************!*\
  !*** ./src/components/ShelfRenderer.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const ShelfRenderer = ({
  ...
  id = "",
  panelType = null,
  // New prop to specify panel type: "side" or "back"
  hideTitle = false
}) => {
  ...
  const getItemGroupClassName = groupKey => {
    ...
    return isEightRow ? "item-group item-group-vertical-row group-position-8" : "item-group item-group-vertical-row";
  };
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `face-shelf face-shelf-${shelfLabel}`
  }, !hideTitle && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "shelf-title common-container"
  ...
  }, sortedGroupKeys.map(groupKey => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: getItemGroupClassName(groupKey),
    key: groupKey
  }, groupedByHorizontal[groupKey].map((item, index) => isInstruction ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(InstructionItem, {
    key: index,
    item: item,
    data: data,
    scale: scale,
    id: id
  }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_AdminItem__WEBPACK_IMPORTED_MODULE_1__["default"], {
    key: index,
    item: item,
    data: data,
