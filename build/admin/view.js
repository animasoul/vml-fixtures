  ...
  const processAndDisplayData = () => {
    ...
    const renderShelf = (positions, shelfLabel) => {
      ...
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        href: "#",
        onClick: () => openModal(`${item.ImageURL || data.ImageURL}${item.code}.jpg`)
    ...
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, "Panel"), shelfP.length > 0 && renderShelf(shelfP, "P"))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)((react_modal__WEBPACK_IMPORTED_MODULE_3___default()), {
      isOpen: isModalOpen,
