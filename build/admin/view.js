...
const RootApp = () => {
  ...
  const processAndDisplayData = () => {
    ...
    const bays = (0,_utilities_shelfUtils__WEBPACK_IMPORTED_MODULE_7__.organizeBayData)(data, selectedFixtureType, selectedRegion);
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, selectedFixtureType, " - ", selectedRegion), Object.entries(bays).sort(([a], [b]) => a - b).map(([bayNumber, bayData]) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      id: `bay-${bayNumber}`
    }, Object.keys(bays).length > 1 && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, "Bay ", bayNumber), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "bay-links"
    }, Object.keys(bays).sort((a, b) => a - b).filter(bayNum => bayNum !== bayNumber) // Filter out current bay
    .map(bayNum => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      key: bayNum,
      href: `#bay-${bayNum}`,
      className: "bay-link"
...
const AdminItem = ({
  ...
  }))), showTooltip && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_tooltip__WEBPACK_IMPORTED_MODULE_1__.Tooltip, {
    id: item.code
