...
Item.propTypes = {
  item: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object).isRequired
};
function ItemGroup({
  items
}) {
...
ItemGroup.propTypes = {
  items: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_2___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_2___default().object)), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object)]).isRequired
};
function Shelf({
  shelfData
}) {
...
Shelf.propTypes = {
  shelfData: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object).isRequired
};
