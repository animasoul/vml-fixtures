  ...
  const processAndDisplayData = () => {
    ...
    const renderTwoUp = () => {
      ...
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        }, renderShelfCell(bay1Number, bay1Regular, shelfLabel), renderShelfCell(bay2Number, bay2Regular, shelfLabel)), wideItems.length > 0 && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
          className: "shelf-row__wide"
        }, wideItems.map((item, idx) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_AdminItem__WEBPACK_IMPORTED_MODULE_7__["default"], {
          key: `${item.code}-${idx}`,
          item: item,
          data: data,
          onImageClick: openModal,
...
const ShelfRenderer = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    key: horizontal
  }, groupedByHorizontal[horizontal].map((item, index) => isInstruction ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(InstructionItem, {
    key: index,
    item: item,
    data: data,
    scale: scale,
